...
# data = vrplib.read_instance('/home/emperornao/personal/cvrp/resources/E/E-n101-k14.vrp')
# bks = SimpleNamespace(**vrplib.read_solution('/home/emperornao/personal/cvrp/resources/E/E-n101-k14.sol'))

customers_to_remove = 1
...
# plot_solution(solution, 'Nearest neighbor solution')
    ...
    class Or:
        ...
        def __call__(self, rnd, best, current):
            for pred in self.preds:
                if pred(rnd, best, current):
                    return True
            return False

    stop = MaxRuntime(30)
    noimpr = NoImprovement(1000)
    result = alns.iterate(init, select, accept, Or([stop, noimpr]))
